    ...
    <div class="col-md-offset-2 col-md-8">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="question" name="que" placeholder="Enter your question here" Required>
            </div>
            <div class="form-group">
                <label for="correct_answer">Correct answer</label>
                <input type="text" class="form-control" id="correct_answer" name="ans" placeholder="Enter the correct answer here" Required>
            </div>
            <div class="form-group">
                <label for="wrong_answer1">Wrong Answers</label>
                <input type="text" class="form-control" id="wrong_answer1" name="wrong_answer1" placeholder="This is the daily report of project login_portal for 03/02/2022.This is the daily report of project login_portal for 03/02/2022. 1" Required>
            </div>
            <div class="form-group">
...
@$ans = $_POST['ans'];
$qry = "INSERT INTO `quiz1`(`id`, `que`, `option 1`, `option 2`, `option 3`, `ans`) VALUES ('$id','$que','$wans1','$wans2','$wans3','$ans')";
echo $qry;
