    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="www.technopoints.com">Quiz Test</a>
        </div>
...
<table><?php   $fetchqry = "SELECT * FROM `quiz`";
  ...
  <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;a )&nbsp;&nbsp;&nbsp;<input required type="radio" name="<?php echo $snr;?>" value="<?php echo $row['option_1'];?>">&nbsp;<?php echo $row['option_1']; ?><br>
  ...
  <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;d )&nbsp;&nbsp;&nbsp;<input required type="radio" name="<?php echo $snr;?>" value="<?php echo $row['option_4'];?>">&nbsp;<?php echo $row['option_4']; ?><br><br><br></td></tr>
			    <?php  }
																	?> 
