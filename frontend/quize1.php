...
<body onload="hidder();">
    <header class="header sect_ion">
      ...
      <div class="right-title">Total Questions: <?php  ?><span id="tque"></span></div>
...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-7">
            ...
            <form name="quizForm" onSubmit="" action="result.php" method="post" id="form">
...
<?php   $fetchqry = "SELECT * FROM `quiz`";
		  ...
		  ?>
          <h3>
          <span id="qid"><?php echo @$snr +=1;?></span> <span id="question"><?php echo @$row['que'];?></span></h3>
<!--*<tr><td><h3><br><?php echo @$snr +=1;?>&nbsp;-&nbsp;<?php echo @$row['que'];?></h3></td></tr>-->
  a )&nbsp;&nbsp;&nbsp;<input required type="radio" name="<?php echo $snr;?>" value="<?php echo $row['option 1'];?>">&nbsp;<?php echo $row['option 1']; ?><br>
  b )&nbsp;&nbsp;&nbsp;<input required type="radio" name="<?php echo $snr;?>" value="<?php echo $row['option 2'];?>">&nbsp;<?php echo $row['option 2'];?>
  c )&nbsp;&nbsp;&nbsp;<input required type="radio" name="<?php echo $snr;?>" value="<?php echo $row['option 3'];?>">&nbsp;<?php echo $row['option 3']; ?>
  d )&nbsp;&nbsp;&nbsp;<input required type="radio" name="<?php echo $snr;?>" value="<?php echo $row['option 4'];?>">&nbsp;<?php echo $row['option 4']; ?><br><br><br>
			    <?php  }
																	?> 
...
<!--<div class="time" id="navbar" style="margin-top:100px">Time left :<span id="timer"></span></div>
<button class="button" id="mybut" onclick="myFunction()">START QUIZ</button>-->
        		<div class="text-center" id="navbar">Time Remaning <span id="timer"></span>
                <button class="button" id="mybut" onclick="myFunction()">START QUIZ</button>
                <script>
function myFunction() {
