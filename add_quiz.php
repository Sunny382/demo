...
<div class="row">
    <div class="col-md-offset-2 col-md-8">
        ...
        <form action="" method="post">
            ...
            <div class="form-group">
                <label class="sr-only" for="wrong_answer4">Wrong Answers 4</label>
                <input type="text" class="form-control" id="wrong_answer4" name="wrong_answer4" placeholder="Option 4" Required>
            </div>
            <div class="form-group">
                <label class="sr-only" for="userans">User Ans</label>
                <input type="hidden" class="form-control" id="userans" name="userans" placeholder="Userans" Required>
            </div>
...
$qry = "INSERT INTO `quiz`(`id`, `que`, `option_1`, `option_2`, `option_3`, `option_4`, `ans`, `userans`) VALUES ($id,'$que','$wans1','$wans2','$wans3','$wans4','$ans','$userans')";
//echo $qry;
